...
async def getImg(req: Request):
        ...
        score_list, scalp_type = Scoring('./image', survey)

        recommend_list, serum_list = Recommend(survey, score_list)
        ...
        return {'value': score_list, 'scalp_type': scalp_type,
                'recommend': recommend_list,
                'recommend_serum': serum_list,
                'image_FH': img_encode_list[0],
                'image_TH': img_encode_list[1],
                'image_LH': img_encode_list[2],
                'image_ETC': img_encode_list[3]}
